...
def main():
    ...
    vid.add_argument("--model",          default="models/best4.pt", help="Path to your custom YOLO weights")
    vid.add_argument("--conf",           type=float, default=0.40, help="Confidence threshold for ball detection")
    ...
    if args.command == "video":
        from integration.pipeline.video_pipeline import run as run_video_pipeline
